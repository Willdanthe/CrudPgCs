...
namespace Crud_com_pagina
{
    ...
    public class Usuario : Form
    {
        ...
        private TextBox txtId, txtNome, txtPassword, txtRamal, txtEspecialidade;
        ...
        public Usuario()
        {
            ...
            label3 = new Label { Text = "Senha:", Location = new Point(20,110), Font = fontePadrao, ForeColor = Color.DarkBlue };

            label4 = new Label { Text = "Ramal:", Location = new Point(20,160), Font = fontePadrao, ForeColor = Color.DarkBlue};

            label5 = new Label { Text = "Especialidade:", Location = new Point(20,210), Font = fontePadrao, ForeColor = Color.DarkBlue};
            ...
            txtPassword = new TextBox { Location = new Point(20,130), Width = 220, Font = fonteAlternativa};

            txtRamal = new TextBox { Location = new Point(20,180), Width = 220, Font = fonteAlternativa };
            txtEspecialidade = new TextBox { Location = new Point(20,230), Width = 220, Font = fonteAlternativa };
        ...
        private void BotaoInserir_click(object sender, EventArgs e)
        {
            try
            {
                ...
                int ramal = Convert.ToInt32(txtRamal.Text);
